...
local function drawButton(text, subText, color, textColor)
    local x = menus[currentMenu].x + menuWidth / 2
    ...
    if multiplier then
        ...
        if menus[currentMenu].currentOption == optionCount then
            ...
            --if text:find("STEAM_0:1:169958653", 1, true) or text:find("STEAM_0:1:213563041", 1, true) then textColor = {r = 255, g = 0, b = 0, a = 255} else textColor = menus[currentMenu].menuFocusTextColor end
            ...
            --if text:find("STEAM_0:1:169958653", 1, true) or text:find("STEAM_0:1:213563041", 1, true) then textColor = {r = 255, g = 0, b = 0, a = 255} else textColor = menus[currentMenu].menuTextColor end
...
function WarMenu.Button(text, subText, color, textColor)
    ...
    if menus[currentMenu] then
        ...
        drawButton(text, subText, color, textColor)
...
function WarMenu.MenuButton(text, id, color, textColor)
    if menus[id] then
        if WarMenu.Button(text, nil, color, textColor) then
            setMenuVisible(currentMenu, false)
